...
function fromHex(hexStr) {
  ...
  const intArr = ((_a5 = padded.match(/[0-9a-fA-F]{2}/g)) == null ? void 0 : _a5.map((byte) => parseInt(byte, 16))) ?? [];
...
// node_modules/.pnpm/@mysten+utils@0.3.1/node_modules/@mysten/utils/dist/mitt.mjs
function mitt(all) {
...
function uIntBcsType({ readMethod, writeMethod, ...options }) {
  return fixedSizeBcsType({
    ...
    validate: (value) => {
      ...
      (_a5 = options.validate) == null ? void 0 : _a5.call(options, value);
    }
  });
}
...
var BcsStruct = class extends BcsType {
  constructor({ name, fields, ...options }) {
    ...
    super({
      ...
      validate: (value) => {
        var _a5;
        (_a5 = options == null ? void 0 : options.validate) == null ? void 0 : _a5.call(options, value);
...
function getSpecificMessage(reference, lang) {
  var _a5;
  return (_a5 = store$1 == null ? void 0 : store$1.get(reference)) == null ? void 0 : _a5.get(lang);
}
function _stringify(input) {
  ...
  if (type === "object" || type === "function") return (input && ((_b = (_a5 = Object.getPrototypeOf(input)) == null ? void 0 : _a5.constructor) == null ? void 0 : _b.name)) ?? "null";
  return type;
}
        ...
        for (let key = 0; key < input.length; key++) {
          ...
          if (itemDataset.issues) {
            ...
            for (const issue of itemDataset.issues) {
              ...
              (_a5 = dataset.issues) == null ? void 0 : _a5.push(issue);
            }
...
function serializeV1TransactionData(transactionData) {
  ...
  return {
    ...
    expiration: ((_a5 = transactionData.expiration) == null ? void 0 : _a5.$kind) === "Epoch" ? { Epoch: Number(transactionData.expiration.Epoch) } : transactionData.expiration ? { None: true } : null,
    gasConfig: {
...
function transactionDataFromV1(data) {
  ...
  return parse(TransactionDataSchema, {
    ...
    gasData: {
      ...
      budget: ((_a5 = data.gasConfig.budget) == null ? void 0 : _a5.toString()) ?? null,
...
var TransactionDataBuilder = class TransactionDataBuilder2 {
  ...
  static fromBytes(bytes) {
    var _a5;
    const data = (_a5 = suiBcs.TransactionData.parse(bytes)) == null ? void 0 : _a5.V1;
  ...
  insertTransaction(atCommandIndex, otherTransaction) {
    ...
    for (let i = 0; i < otherTransaction.inputs.length; i++) {
      ...
      if (id !== void 0) {
        ...
        if (existingIndex !== -1 && ((_a5 = this.inputs[existingIndex].Object) == null ? void 0 : _a5.SharedObject) && ((_b = otherInput.Object) == null ? void 0 : _b.SharedObject)) this.inputs[existingIndex].Object.SharedObject.mutable = this.inputs[existingIndex].Object.SharedObject.mutable || otherInput.Object.SharedObject.mutable;
      }
...
async function resolveCoinBalance(transactionData, buildOptions, next) {
  ...
  for (const input of transactionData.inputs) {
    if ((_a5 = input.Object) == null ? void 0 : _a5.ImmOrOwnedObject) usedIds.add(input.Object.ImmOrOwnedObject.objectId);
  ...
  if (!transactionData.gasData.payment) {
    ...
    const paymentCoins = coins.objects.filter((coin) => {
      return !transactionData.inputs.find((input) => {
        var _a5;
        if ((_a5 = input.Object) == null ? void 0 : _a5.ImmOrOwnedObject) return coin.objectId === input.Object.ImmOrOwnedObject.objectId;
        return false;
      });
...
async function resolveObjectReferences(transactionData, client) {
  const objectsToResolve = transactionData.inputs.filter((input) => {
    var _a5;
    return input.UnresolvedObject && !(input.UnresolvedObject.version || ((_a5 = input.UnresolvedObject) == null ? void 0 : _a5.initialSharedVersion));
  });
...
async function normalizeInputs(transactionData, client) {
  ...
  commands.forEach((command) => {
    ...
    params.forEach((param, i) => {
      ...
      const inputValue = ((_a5 = input.UnresolvedPure) == null ? void 0 : _a5.value) ?? ((_b = input.UnresolvedObject) == null ? void 0 : _b.objectId);
...
async function resolveTransactionPlugin(transactionData, options, next) {
  ...
  return (((_a5 = getClient2(options).core) == null ? void 0 : _a5.resolveTransactionPlugin()) ?? coreClientResolveTransactionPlugin)(transactionData, options, async () => {
    await validate(transactionData);
    await next();
  });
}
...
var MvrClient = (_a3 = class {
  ...
  async resolve({ types = [], packages = [] }) {
    ...
    const typeMap = { ...(_a5 = __privateGet(this, _overrides)) == null ? void 0 : _a5.types };
  ...
  return __privateGet(this, _cache).readSync(["#mvrPackageDataLoader", __privateGet(this, _url) ?? ""], () => {
    ...
    const overrides = (_a5 = __privateGet(this, _overrides)) == null ? void 0 : _a5.packages;
  ...
  return __privateGet(this, _cache).readSync(["#mvrTypeDataLoader", __privateGet(this, _url) ?? ""], () => {
    ...
    const overrides = (_a5 = __privateGet(this, _overrides)) == null ? void 0 : _a5.types;
  ...
  await Promise.all(batches.map(async (batch) => {
    ...
    for (const pkg of Object.keys(data == null ? void 0 : data.resolution)) {
      const pkgData = (_a5 = data.resolution[pkg]) == null ? void 0 : _a5.package_id;
      if (!pkgData) continue;
      results[pkg] = pkgData;
    }
  }));
  ...
  await Promise.all(batches.map(async (batch) => {
    ...
    for (const type of Object.keys(data == null ? void 0 : data.resolution)) {
      const typeData = (_a5 = data.resolution[type]) == null ? void 0 : _a5.type_tag;
...
function replaceNames(builder, resolved) {
  ...
  for (const command of builder.commands) {
    if ((_a5 = command.MakeMoveVec) == null ? void 0 : _a5.type) {
...
var Transaction = (_a4 = class {
  constructor() {
    ...
    this.object = createObjectMethods((value) => {
      ...
      if (((_a5 = inserted == null ? void 0 : inserted.Object) == null ? void 0 : _a5.SharedObject) && typeof value === "object" && ((_b = value.Object) == null ? void 0 : _b.SharedObject)) inserted.Object.SharedObject.mutable = inserted.Object.SharedObject.mutable || value.Object.SharedObject.mutable;
      return inserted ? {
        $kind: "Input",
  ...
  */
  static from(transaction) {
    ...
    if (__privateGet(newTransaction, _data).commands.some((cmd) => {
      var _a5;
      return ((_a5 = cmd.$Intent) == null ? void 0 : _a5.name) === COIN_WITH_BALANCE;
  ...
  */
  isPreparedForSerialization(options = {}) {
    ...
    if (__privateGet(this, _data).commands.some((cmd) => {
      var _a5;
      return cmd.$Intent && !((_a5 = options.supportedIntents) == null ? void 0 : _a5.includes(cmd.$Intent.name));
    })) return false;
    return true;
  }
  /**
  ...
  */
  ...
  async prepareForSerialization(options) {
    ...
    for (const intent of intents) {
      if ((_a5 = options.supportedIntents) == null ? void 0 : _a5.includes(intent)) continue;
  ...
  const filteredCommands = orderedCommands.filter((cmd) => {
    var _a6;
    return ((_a6 = cmd.$Intent) == null ? void 0 : _a6.name) !== "AsyncTransactionThunk";
  });
  ...
  function getOriginalIndex(index) {
    ...
    if (((_a6 = command.$Intent) == null ? void 0 : _a6.name) === "AsyncTransactionThunk") {
  ...
  for (const [i, cmd] of unorderedCommands.entries()) if (((_a5 = cmd.$Intent) == null ? void 0 : _a5.name) === "AsyncTransactionThunk") try {
...
*/
//# sourceMappingURL=chunk-XYNTYUCC.js.map
